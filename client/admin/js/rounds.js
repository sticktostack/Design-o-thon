...
async function loadRounds() {
  const response = await fetch("https://api-design-o-thon.onrender.com/api/round/all");
...
roundForm.addEventListener("submit", async (e) => {
  ...
  const response = await fetch("https://api-design-o-thon.onrender.com/api/round/add", {
    method: "POST",
    headers: {
...
async function deleteRound(id) {
  await fetch(`https://api-design-o-thon.onrender.com/api/round/delete/${id}`, {
    method: "DELETE"
  });
